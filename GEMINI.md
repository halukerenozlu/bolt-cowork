...
- v0.4.6 (next) -- Bug fixes and performance improvements Go
- v0.4.7 (planned) -- Desktop App -- Phase 1 (Electron + Go backend skeleton) Go + TS
- v0.4.8 (planned) -- Desktop App -- Phase 2 Go + TS
- v0.4.9 (planned) -- Desktop App -- Phase 3 Go + TS
- v0.4.10 (planned) -- Sub-agent coordination (parallel tasks via goroutines, dependency management) Go + Shell
- v0.4.11 (planned) -- Custom LLM provider (FastAPI, HTTP-based provider, benchmark tool) Go + Shell
