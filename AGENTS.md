...
| v0.4.6  | Custom LLM provider (FastAPI, HTTP-based provider, benchmark tool)                                                                                                                   | Go + Shell | 🔄 Next        |
| v0.4.7  | Bug fixes and performance improvements                                                                                                                                               | Go         | ⬜ Planned     |
| v0.4.8  | Desktop App — Phase 1 (Electron + Go backend)                                                                                                                                        | Go + TS    | ⬜ Planned     |
| v0.4.9  | Desktop App — Phase 2                                                                                                                                                                | Go + TS    | ⬜ Planned     |
| v0.4.10 | Desktop App — Phase 3                                                                                                                                                                | Go + TS    | ⬜ Planned     |
| v0.4.11 | Sub-agent coordination (parallel tasks via goroutines, dependency management)                                                                                                        | Go + Shell | ⬜ Planned     |
