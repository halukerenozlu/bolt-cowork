...
| v0.4.6  | Bug fixes and performance improvements                                                                                                                                               | Go         | 🔄 Next        |
| v0.4.7  | Desktop App — Phase 1 (Electron + Go backend skeleton)                                                                                                                               | Go + TS    | ⬜ Planned     |
| v0.4.8  | Desktop App — Phase 2                                                                                                                                                                | Go + TS    | ⬜ Planned     |
| v0.4.9  | Desktop App — Phase 3                                                                                                                                                                | Go + TS    | ⬜ Planned     |
| v0.4.10 | Sub-agent coordination (parallel tasks via goroutines, dependency management)                                                                                                        | Go + Shell | ⬜ Planned     |
| v0.4.11 | Custom LLM provider (FastAPI, HTTP-based provider, benchmark tool)                                                                                                                   | Go + Shell | ⬜ Planned     |
| v0.4.12 | Feedback-driven improvements                                                                                                                                                         | Go         | ⬜ Planned     |
| v0.4.13 | Feedback-driven improvements                                                                                                                                                         | Go         | ⬜ Planned     |
| v0.4.14 | Feedback-driven improvements                                                                                                                                                         | Go         | ⬜ Planned     |
